...
def is_valid_word(word, hand, word_list):
    ...
    if "*" in word:
        if(not wildcard(word.lower(), hand, word_list)):
            return False
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while(calculate_handlen(hand) != 0):
        ...
        if(is_valid_word):
            current_score = get_word_score(hand, calculate_handlen(hand))
            total_score += current_score
            hand = update_hand(hand, word)
            
            print("\"" + str(word) + "\" earned " + str(current_score))
        else:
            hand = update_hand(hand, word)
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    for i in range(number_of_hands):
        ...
        score_1 = play_hand(current_hand.copy(), word_list)
        score_2 = 0
        print("----------")
        
        replay = input("Would you like to replay the hand? ")
        if(replay == "yes"):
            score_2 = play_hand(current_hand.copy(), word_list)
